...
#include "custom_msg/msg/detail/coordinates__rosidl_typesupport_fastrtps_c.h"
...
using _Coordinates__ros_msg_type = custom_msg__msg__Coordinates;
...
size_t get_serialized_size_custom_msg__msg__Coordinates(
  const void * untyped_ros_message,
...
static uint32_t _Coordinates__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msg__msg__Coordinates(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msg
size_t max_serialized_size_custom_msg__msg__Coordinates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msg__msg__Coordinates;
    is_plain =
      (
...
static size_t _Coordinates__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msg__msg__Coordinates(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msg, msg, Coordinates)() {
