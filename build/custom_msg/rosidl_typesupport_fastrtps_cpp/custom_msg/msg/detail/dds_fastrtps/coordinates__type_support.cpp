...
#include "custom_msg/msg/detail/coordinates__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msg::msg::Coordinates & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msg::msg::Coordinates & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msg::msg::Coordinates;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msg::msg::Coordinates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msg::msg::Coordinates *>(
    untyped_ros_message);
...
{
  return &custom_msg::msg::typesupport_fastrtps_cpp::_Coordinates__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg, msg, Coordinates)() {
  return &custom_msg::msg::typesupport_fastrtps_cpp::_Coordinates__handle;
}
